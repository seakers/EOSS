...
method2 = '5000eval_learning_withSinglecross/';
...
for i=1:n_representatives
    ...
    scatter(-pop1(:,1),pop1(:,2)*33495.939796,'b')
    hold on
    scatter(-pop2(:,1),pop2(:,2)*33495.939796,'r')
    hold off
...
legend( '\epsilonMOEA','AOS with Learned operators')
