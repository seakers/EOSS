...
public class DrivingFeaturesParams {
    ...
    public static double support_threshold = 0.1;
    public static double confidence_threshold = 0.4;
    public static double lift_threshold = 1.0;
//    public static double support_threshold = 0.0;
//    public static double confidence_threshold = 0.0;
//    public static double lift_threshold = 0.0;
