...
//	ArrayList<SetOfFeatures> featureSet;
    public static ArrayList<SetOfFeatures> minRedundancyMaxRelevance(DoubleMatrix dataFeatureMat, ArrayList<SetOfFeatures> featureSet, int target_num_features) {

        int ncols = dataFeatureMat.columns;
        int nrows = dataFeatureMat.rows;
    ...
    public static double getMutualInformation(DoubleMatrix features_sat, DoubleMatrix label, int f1, int l1) {
        return getMutualInformation(features_sat, label, f1, l1, -1, -1);
    }

    public static double getMutualInformation(DoubleMatrix features_sat, DoubleMatrix label, int f1, int l1, int f2, int l2) {

        double I;
        double x1, x2, x1x2, nx1x2, x1nx2, nx1nx2;
        int nrows = features_sat.rows;
