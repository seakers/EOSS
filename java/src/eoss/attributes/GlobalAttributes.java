...
// List of measurement parameters
    ...
    public static void defineMeasurement(HashMap<String, Integer> attribs, HashMap<Integer, String> attribKeys, HashMap<String, String> attribTypes, HashMap<String,EOAttribute> attribSet){
   ...
   public static void defineInstrument(HashMap<String, Integer> attribs, HashMap<Integer, String> attribKeys, HashMap<String, String> attribTypes, HashMap<String,EOAttribute> attribSet){
