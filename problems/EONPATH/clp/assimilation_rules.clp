...
(defrule ASSIMILATION2::modify-temporal-resolution
	(ASSIMILATION2::UPDATE-REV-TIME (parameter ?p) (avg-revisit-time-global# ?new-time) (avg-revisit-time-US# ?new-time-us))
	?meas <- (REQUIREMENTS::Measurement (Parameter ?p) (avg-revisit-time-global# nil) (avg-revisit-time-US# nil))
	=>
